...
// CompressorTool: 内容组件（不含 Header / Footer）。
// - 根 `app/page.tsx` 用它来组装：<HeaderClient /><CompressorTool /><FooterClient />
// - `[lang]/page.tsx` 直接 render 它：<CompressorTool />（[lang]/layout 已提供 Header/Footer）
// 这样无论走哪条路径，Header 都只渲染一次。
